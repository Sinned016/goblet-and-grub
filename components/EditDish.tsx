...
import { dish, EDIT_DISH } from "@/lib/queries";
...
export default function EditDish({ dish }: { dish: dish }) {
  ...
  async function handleEditDish() {
    const editDishString = print(EDIT_DISH);
  ...
  return (
    <div className="max-w-3xl mx-auto flex flex-col gap-4 ">
      <form className="flex flex-col gap-2" onSubmit={handleSave}>
        ...
        <div>
          ...
          <input
            ...
            onKeyDown={(e) => handleKeyDown(e, newIngredient, setNewIngredient)}
          />
                ...
                >
                  ...
                  <X
                    ...
                    onClick={() =>
                      setNewDish((prev) => ({
                        ...prev,
                        tags: prev.tags.filter((_, tagIndex) => tagIndex !== i),
                      }))
                    }
                  />
                </div>
      ...
      <Dialog open={openSaveDish} onOpenChange={setOpenSaveDish}>
        <DialogContent>
          <DialogHeader>
            <DialogTitle>Edit {newDish?.title}?</DialogTitle>
            <DialogDescription>
              Are you sure you want to edit {newDish?.title}?
            </DialogDescription>
          </DialogHeader>
